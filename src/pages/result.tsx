        ...
        <div className="w-screen h-[1600px] flex flex-col bg-result-bg bg-center bg-cover font-pretendard">
            <div className="flex flex-col h-full w-full mx-auto px-auto mt-0 border">
                ...
                <div className="text-center mt-[187px] text-result-title font-normal not-italic">
                    이 <span className="font-bold">향수</span>를 <span className="font-bold">추천</span>드려요!
                </div>
                <div className="flex mx-auto w-[1180px] h-[532px] mt-[52px] shadow-main-div border border-white rounded-[30px] bg-white-70">
                    <div className="ml-[100px]">
                        <div className="ml-1 mt-[85px] text-2xl font-medium text-caption1 tracking-caption1">
                            {mainPerfume.brand}
                        </div>
                        <div className="ml-1 mt-4 text-5xl font-semibold leading-tight">
                            {mainPerfume.name}
                        </div>
                        <div className="ml-1 mt-1.5 text-caption1 font-normal leading-tight text-[28px]">
                            {mainPerfume.ename}
                        </div>
                        <div className="ml-1 mt-10 text-caption1 font-normal text-sub-content max-w-[346px]">
                            {mainPerfume.content}
                        </div>
                        <div
                    ...
                    <div className="flex justify-center justify-end mt-16 w-[578px]">
                        <div>
                            <img src={mainPerfume.imageURL} />
                        </div>
                    </div>
                </div>

                {/* 비슷한 제품*/}
                <div className="mt-0.5 text-left mx-auto w-[1180px] text-result-subtitle text-result-subtitle mt-40">
                ...
                <div className="h-full mx-auto ">
                    ...
                    <div className="flex mt-14 justify-between">
                        <button className="mr-[42px]" onClick={prevClick} disabled={currentPage === 0}>
                            <img src={left} />
                        </button>
                            ...
                            {subPerfumes
                                ...
                                .map((data) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 hidden justify-center group-hover:flex group-hover:bg-black group-hover:bg-opacity-40 rounded-[20px] flex justify-center items-center">
                        ...
                        <button
                            className="ml-[42px]"
                            onClick={nextClick}
                            disabled={currentPage >= subPerfumes.length - subPerfumePerPage}
                        >
                            <img src={right} />
                        </button>
                    </div>
